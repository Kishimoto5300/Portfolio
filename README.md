...
講義や自主学習を通じて、ライブラリを利用するだけでなく、アルゴリズムの理論的背景を理解した上での実装に取り組みました。

作品一覧

CV_p1_homography.ipynb　　　　コンピュータビジョンにおけるホモグラフィー変換を実装した課題です。

Classification.ipynb　　　機械学習におけるクラス分類手法を理論に基づいて実装した課題です。
